    ...
    public class MDController : Controller
    {
...

        {
            ...
            if (user.ID == employeeDetails.EmpId)
            {
                foreach (var item in employeeDetail)
                {
                    ...
                    //GM_p_l += GMcalculation(item.EID);
                    MDprofit += _cal.calculation(item.EmpId);
            ...
            if (user.ID == employeeDetails.EmpId)
            {
                ...
                {
                    //CHprofit += Calculation(item.EID);
                    CH_p_l += CHCalculation(item.EmpId);
                    item.CHProfit = CHCalculation(item.EmpId);
        ...
        public decimal CHCalculation(int id)
        {
            ...
            if (employeeDetails.EmpId == id)
            {
                foreach (var item in employeeDetail)
                {
                    CHprofit += _cal.calculation(item.EID);
        ...
        public decimal GMcalculation(int id)
        {
            ...
            if (employeeDetails.EmpId == id)
            {
                foreach (var item in employeeDetail)
                {
                    GMprofit += _cal.calculation(item.EID);
            ...
            if (employeeDetails.EmpId == id)
            {
                foreach (var item in data)
                {
                    ...
                    Manager_p_l += Managercalculation(item.EID);
        ...
        public ActionResult CHDetails(int Id)
        {
            ...
            if (Id == employeeDetails.EmpId)
            {
                    ...
                    foreach (var item in data)
                    {
                        ...
                        item.GMProfit = GMcalculation(item.EmpId);
        ...
        public ActionResult Details(int Id)
        {
            ...
            else
            {
                ...
                decimal Profit_loss = (paidtillnow);
